...
function CustomHeader() {
  ...
  const getHeaderTitle = () => {
    if (pathname === "/") return "Decision Maker";
    if (pathname === "/choices") return "My Choices";
    if (pathname === "/history") return "History";
    if (pathname.includes("/spin/")) return "Spin to Decide";
    return "Random Decision Maker";
  };

  const title = getHeaderTitle();
  const showBackButton = pathname.includes("/spin/");
